...
print("creado")
recognizer_gen.read("edad.yml")

subjects = ["adulto" , "joven", "viejo"]

def draw_rectangle(img, rect):
    (x, y, w, h) = rect
    cv2.rectangle(img, (x, y), (x+w, y+h), (0, 255, 0), 2)
    
#function to draw text on give image starting fromhaarcascade_frontalface_alt.xml
...
#load test images
test_img1 =cv2.imread('edades.jpg',1)
